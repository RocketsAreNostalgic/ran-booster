...
unique release-list entry matching the already established exact tag and merged
commit, then downloads the two named assets by ID. Tag-based release readback
begins only after publication.
