...
<?php } ?>
		<div class="ran-booster-repository-field">
			<input id="ran-booster-repository-name" name="ran_booster[repository]" type="text" class="regular-text ran-booster-repository-input" placeholder="<?php esc_attr_e( 'repo-name/package-name', 'ran-booster' ); ?>" value="<?php echo esc_attr( $repositoryValue ); ?>" maxlength="512" required <?php disabled( $repositoryReadOnly ); ?>>
